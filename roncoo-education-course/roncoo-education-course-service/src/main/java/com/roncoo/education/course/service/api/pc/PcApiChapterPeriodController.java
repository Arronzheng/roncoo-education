 ...
 */
@RestController
@RequestMapping(value = "/course/pc/course/period")
public class PcApiChapterPeriodController extends BaseController {

	@Autowired
	private PcApiChapterPeriodBiz biz;
	...
	public Result<Page<ChapterPeriodPageRESQ>> listForPage(@RequestBody ChapterPeriodPageREQ chapterPeriodPageRESQ) {
	...
	public Result<Integer> save(@RequestBody ChapterPeriodSaveREQ chapterPeriodSaveREQ) {
	 ...
	 * 更新课时分类信息
	 * 
	 * @param chapterPeriodUpdateREQ
	 * @return
	 */
	@ApiOperation(value = "更新课时信息", notes = "更新课时信息")
	@RequestMapping(value = "/update", method = RequestMethod.POST)
	public Result<Integer> update(@RequestBody ChapterPeriodUpdateREQ chapterPeriodUpdateREQ) {
		return biz.update(chapterPeriodUpdateREQ);
	}
}
