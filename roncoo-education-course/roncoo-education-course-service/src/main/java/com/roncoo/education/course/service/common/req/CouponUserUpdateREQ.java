...
@ApiModel(value = "CouponUser更新请求对象", description = "优惠券发放记录表")
public class CouponUserUpdateREQ implements Serializable {

        private static final long serialVersionUID = 1L;

        @ApiModelProperty(value = "优惠券发放记录id", required = true)
