...
public class CourseCommentPageRESQ implements Serializable {
        ...
        private String parentUserExtName;
        /**
         * 评论回复集合
         */
        private List<CourseCommentPageRESQ> children;
}