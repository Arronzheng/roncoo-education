...
@ApiModel(value = "AssembleCoursePageREQ分页请求对象", description = "拼团产品表")
public class AssembleCoursePageRESQ implements Serializable {
        ...
        @ApiModelProperty(value = "分类1名")
        private String categoryName1;
        @ApiModelProperty(value = "分类2名")
        private String categoryName2;
        @ApiModelProperty(value = "分类3名")
